...
parser.add_argument(
    '--flame_model_path',
    type = str,
    default = '/home/finnschaefer/voca/flame/generic_model.pkl',
...
parser.add_argument(
    ...
    type = str,
    default = '/home/finnschaefer/voca/flame/flame_static_embedding.pkl',
...
parser.add_argument(
    ...
    type = str,
    default = '/home/finnschaefer/voca/flame/flame_dynamic_embedding.npy',
