...
def fit_lmk3d( lmk_3d,                      # input landmark 3d
               ...
               shape_num=100, expr_num=50, opt_options=None ):
...
def run_fitting(lmk_3d):
    # model
    model_path = '../model/generic_model.pkl' # change to 'female_model.pkl' or 'male_model.pkl', if gender is known
    ...
    # landmark embedding
    lmk_emb_path = '../model/flame_static_embedding.pkl' 
    lmk_face_idx, lmk_b_coords = load_embedding(lmk_emb_path)
    print(lmk_face_idx.size)
